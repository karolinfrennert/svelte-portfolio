...
const Root = (0, import_index_38cedc01.c)(($$result, $$props, $$bindings, slots) => {
	let { stores } = $$props;
	let { page } = $$props;
	...
	(0, import_index_38cedc01.s)('__svelte__', stores);
...
${
	components[1]
		? `${(0, import_index_38cedc01.v)(
				components[0] || import_index_38cedc01.m,
				'svelte:component'
		  ).$$render(
				$$result,
				...
				{},
				{
					default: () => {
						return `${
							components[2]
								? `${(0, import_index_38cedc01.v)(
										components[1] || import_index_38cedc01.m,
										'svelte:component'
								  ).$$render(
										$$result,
										...
										{
											default: () => {
												return `${(0, import_index_38cedc01.v)(
													components[2] || import_index_38cedc01.m,
													'svelte:component'
	...
	async respond(request, options = {}) {
		...
		if (!this.options.hooks) {
			const module2 = await Promise.resolve().then(() =>
				__toESM(require('./chunks/hooks-93fa095d.js'))
			);
			this.options.hooks = {
